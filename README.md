...
Para executar, primeiro clone o arquivo aes.py do repositório acima e coloque-o no mesmo diretório do arquivo testAES.py provido
aqui. Depois, basta executar com:
 - $ python testAES.py 
